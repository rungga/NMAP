...
class HostOpenPorts(HIGVBox):
    ...
    def freeze(self):
        ...
        self.host_tree.set_sort_column_id(-1, gtk.SORT_ASCENDING)
        self.port_list.set_sort_column_id(-1, gtk.SORT_ASCENDING)
        self.port_tree.set_sort_column_id(-1, gtk.SORT_ASCENDING)

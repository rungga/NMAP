    ...
    /* TCP Flags */
        ...
        /* CASE 2: User supplied a list of flags in the format "syn,ack,ecn" */
            ...
            for( size_t f=0; f< strlen(optarg); f+=4 ){
                ...
                else if(!strncasecmp((optarg+f), "PSH",3)){ o.setFlagTCP(FLAG_PUSH);  }
        ...
        /* CASE 3: User supplied flag initials in format "XYZ..."  */        
            ...
            if( strlen(optarg) == 3 ){
                ...
                else if(!strcasecmp(optarg, "PSH")){ o.setFlagTCP(FLAG_PUSH); flag3_ok=true; }
            ...
            if( flag3_ok==false ){
                for(size_t f=0; f<strlen(optarg); f++){
                    switch( optarg[f] ){
                        ...
                        case 'P': case 'p': o.setFlagTCP(FLAG_PUSH); break;

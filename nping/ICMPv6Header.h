...
/***************************************************************************
 * ICMPv6Header.cc -- The ICMPv6Header Class represents an ICMP version 4  *
...
#define ICMPv6_PAYLOAD_LEN 1500

class ICMPv6Header : public NetworkLayerElement {

    private:
        struct nping_icmpv6 {
            u8 type;                     /* ICMPv6 Message Type                   */
            u8 code;                     /* ICMPv6 Message Code                   */
        ...
        typedef struct nping_icmpv6 nping_icmpv6_t;
